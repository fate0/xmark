...
setlocal enableextensions enabledelayedexpansion
    ...
    xcopy %APPVEYOR_BUILD_FOLDER% C:\projects\php-src\ext\xmark\ /s /e /y /q
    ...
    if "%APPVEYOR_REPO_TAG_NAME%"=="" (
        ...
        for /f "delims=" %%l in (php_xmark.h) do (
            if not "%%l"=="" (
                set line=%%l
                if "!line:~8,17!"=="PHP_XMARK_VERSION" (
                    set APPVEYOR_REPO_TAG_NAME=!line:~27,-1!
                )
            )
        )
